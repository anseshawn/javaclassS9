...
<form name="myform" method="post">
	...
	<div class="row justify-content-center mb-3">
		<div class="col-md-8 col-md-offset-2"><h4>내용</h4>
			<textarea name="content" id="content" rows="3" class="form-control">${vo.content}</textarea>
		</div>
	</div>
	<div class="divider2 mx-auto my-4" style="width:70%;"></div>
	<div class="row justify-content-center mb-3">
		<div class="col-md-8 col-md-offset-2 text-right">
			...
			<a href="${ctp}/admin/notice/faqList?pag=${pag}&pageSize=${pageSize}" class="btn btn-main btn-icon btn-round-full">취소</a>
		</div>
	</div>
	<input type="hidden" name="idx" id="${vo.idx}" />
	<input type="hidden" name="partInput" id="partInput" />
</form>
</div>
<p><br/></p>
