       ...
       $(function(){
         ...
         var calendar = new FullCalendar.Calendar(calendarEl, {
           ...
           eventChange: function(info) { // 이벤트가 수정되면 발생하는 이벤트
              ...
              $.ajax({
                type: "POST",
                url: "${ctp}/engineer/scheduleUpdate", // 서버 측 스크립트의 URL
                data: {
                  idx : idx,
                  engineerIdx: ${mVo.idx},
                  title: title,
           ...
           select: function(arg) { // 캘린더에서 드래그로 이벤트를 생성할 수 있다.
             ...
             if (title) {
               ...
               $.ajax({
                   type: "POST",
                   url: "${ctp}/engineer/scheduleInput", // 서버 측 스크립트의 URL
                   data: {
                     title: title,
                     engineerIdx: ${mVo.idx},
           ...
           eventClick: function(info) {
             ...
             if(ans) {
               ...
               $.ajax({
                   type: "POST",
                   url: "${ctp}/engineer/scheduleDelete", // 서버 측 스크립트의 URL
                   data: {
                     title: title,
                     engineerIdx: ${mVo.idx},
                     start: start,
